 <?php
        ...
        $connectionOptions = array("diariodb"=>"usuarios",
           "Uid"=>"CloudSAcff10363", "PWD"=>"Yeiker342461323", "LoginTimeout" => $connectionTimeoutSeconds);
        $conn = null;
        ...
        for ($cc = 1; $cc <= $maxCountTriesConnectAndQuery; $cc++) {
            ...
            if ($conn === true) {
                ...
                $tsql = "SELECT NAME FROM diariodb.usuarios";
